...
export const metadata = { title: 'Issued Materials | SMLS' }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Track materials issued to shipbuilding operations and work orders"
      >
        <Link
          href="/issued/new"
              ...
              {allIssues.length === 0 ? (
                <tr>
                  <td colSpan={7} className="px-4 py-10 text-center text-sm text-gray-400">
                    ...
                    <Link href="/issued/new" className="text-blue-600 hover:underline">
                      Create one
                    </Link>
                  </td>
                </tr>
